...
namespace Kryz.DI.Tests
{
	public class ContainerTests
	{
		...
		public static void Register(IBuilder builder, (Type, Type)[] registerTypes, Lifetime lifetime)
		{
		...
		private static void Register(IBuilder builder, (Type, Type) types, Lifetime lifetime)
		{
